...
namespace WXKJ.Framework.Webs.Extensions {
    /// <summary>
    /// Swagger扩展
    /// </summary>
    public static class Extensions {
        ...
        public static IApplicationBuilder UseSwaggerX( this IApplicationBuilder builder,Action<SwaggerUIOptions> swaggerUiSetup = null ) {
            ...
            builder.UseSwaggerUI( options => {
                options.IndexStream = () => typeof( Extensions ).GetTypeInfo().Assembly.GetManifestResourceStream( "WXKJ.Framework.Webs.Swaggers.index.html" );
