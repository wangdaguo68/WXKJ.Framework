...
using ClaimTypes = WXKJ.Framework.Security.Claims.ClaimTypes;
using Convert = WXKJ.Framework.Helpers.Convert;
using ISession = WXKJ.Framework.Sessions.ISession;

namespace WXKJ.Framework.Security
{
    /// <summary>
    /// 用户会话扩展
    /// </summary>
