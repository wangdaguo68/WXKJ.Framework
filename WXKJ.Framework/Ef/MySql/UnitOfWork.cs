...
using WXKJ.Framework.Datas.Ef.Internal;

namespace WXKJ.Framework.Datas.Ef.MySql {
    /// <summary>
    /// MySql工作单元
    /// </summary>
    public abstract class UnitOfWork: UnitOfWorkBase {
        ...
        protected override IEnumerable<WXKJ.Framework.Datas.Ef.Core.IMap> GetMapInstances( Assembly assembly ) {
            return WXKJ.Framework.Helpers.Reflection.GetInstancesByInterface<IMap>( assembly );
        }
