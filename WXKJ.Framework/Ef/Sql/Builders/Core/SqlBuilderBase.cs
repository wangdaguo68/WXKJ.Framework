...
using System.Linq;
using System.Text;
using WXKJ.Framework.Datas.Sql.Builders.Clauses;
using WXKJ.Framework.Datas.Sql.Builders.Filters;
...
namespace WXKJ.Framework.Datas.Sql.Builders.Core
{
    /// <summary>
    /// Sql生成器
    /// </summary>
    public abstract class SqlBuilderBase : ISqlBuilder, IClauseAccessor, IUnionAccessor, ICteAccessor {
        ...
        protected void CreateCte( StringBuilder result ) {
            ...
            result.AppendLine( cte.ToString().RemoveEnd( $",{Environment.NewLine}" ) );
        }
