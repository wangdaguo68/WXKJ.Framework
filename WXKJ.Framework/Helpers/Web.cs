...
namespace WXKJ.Framework.Helpers
{
    ...
    public static class Web {
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static WXKJ.Framework.Webs.Clients.WebClient Client() {
            return new WXKJ.Framework.Webs.Clients.WebClient();
        }
